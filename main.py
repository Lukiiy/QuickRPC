...
def parseArguments():
    ...
    p.add_argument("--details", default = "", help = "Main details text (e.g. \"Playing Game\")")
    p.add_argument("--state", default = "", help = "Secondary text")
    p.add_argument("--large-image", default = None, help = "Key of the large image asset")
    ...
    p.add_argument("--once", action = "store_true", help = "Execute and exit")
